# This code was derived from https://github.com/eleannavali/resnet-18-autoencoder/blob/main/src/classes/resnet_using_basic_block_decoder.py
...
class Decoder(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        x = self.de_conv1(x)
        x = self.bn1(x)
        # x = self.relu(x) # Remove final ReLU since image normalisation may make image pixel intensities to fall below 0
        return x
